...
export default function NotFoundResource({
  title = "Halaman Tidak Ditemukan", // Default title
  description = "Maaf, sumber daya yang Anda cari tidak ditemukan. Mungkin halaman telah dihapus, namanya diubah, atau Anda mengetikkan alamat yang salah.", // Default description
}: NotFoundPageProps) {
