...
type TableType = Awaited<ReturnType<typeof getCategoryData>>;

export type CategoryColumnType = TableType["data"][number];

export function TabelCategory({ promises }: { promises: TableType }) {
